...
//    Tetromino::shape = O_PIECE;
    ...
    switch(shape){
        case I_PIECE: {
            ...
            n_rot.fragments.push_back(Fragment(0, 1, AQUA));
            n_rot.fragments.push_back(Fragment(1, 1, AQUA));
            n_rot.fragments.push_back(Fragment(2, 1, AQUA));
            n_rot.fragments.push_back(Fragment(3, 1, AQUA));
            n_rot.height = 2;
            n_rot.width = 4;
            
            //Eastern Rotation
            Rotation e_rot;
            e_rot.fragments.push_back(Fragment(1, 0, AQUA));
            e_rot.fragments.push_back(Fragment(1, 1, AQUA));
            e_rot.fragments.push_back(Fragment(1, 2, AQUA));
            e_rot.fragments.push_back(Fragment(1, 3, AQUA));
            e_rot.height = 4;
            e_rot.width = 1;
            
            //Southern Rotation
            Rotation s_rot;
            s_rot.fragments.push_back(Fragment(0, 1, AQUA));
            s_rot.fragments.push_back(Fragment(1, 1, AQUA));
            s_rot.fragments.push_back(Fragment(2, 1, AQUA));
            s_rot.fragments.push_back(Fragment(3, 1, AQUA));
            s_rot.height = 2;
            s_rot.width = 4;
            
            //Western Rotation
            Rotation w_rot;
            w_rot.fragments.push_back(Fragment(1, 0, AQUA));
            w_rot.fragments.push_back(Fragment(1, 1, AQUA));
            w_rot.fragments.push_back(Fragment(1, 2, AQUA));
            w_rot.fragments.push_back(Fragment(1, 3, AQUA));
            w_rot.height = 4;
            w_rot.width = 1;
        ...
        case T_PIECE:{
            ...
            //Northern(standard) Rotation
            Rotation n_rot;
            n_rot.fragments.push_back(Fragment(0, 1, PURPLE));
            n_rot.fragments.push_back(Fragment(1, 1, PURPLE));
            n_rot.fragments.push_back(Fragment(2, 1, PURPLE));
            n_rot.fragments.push_back(Fragment(1, 2, PURPLE));
            n_rot.height = 3;
            n_rot.width = 3;
            ...
            //Western Rotation
            Rotation w_rot;
            w_rot.fragments.push_back(Fragment(1, 0, PURPLE));
            w_rot.fragments.push_back(Fragment(1, 1, PURPLE));
            w_rot.fragments.push_back(Fragment(2, 1, PURPLE));
            w_rot.fragments.push_back(Fragment(1, 2, PURPLE));
            w_rot.height = 3;
            w_rot.width = 2;
        ...
        case S_PIECE:{
            ...
            n_rot.fragments.push_back(Fragment(2, 1, GREEN));
            n_rot.fragments.push_back(Fragment(0, 2, GREEN));
            n_rot.fragments.push_back(Fragment(1, 2, GREEN));
            n_rot.height = 3;
            n_rot.width = 3;
            
            //Eastern Rotation
            Rotation e_rot;
            e_rot.fragments.push_back(Fragment(1, 0, GREEN));
            e_rot.fragments.push_back(Fragment(1, 1, GREEN));
            e_rot.fragments.push_back(Fragment(2, 1, GREEN));
            e_rot.fragments.push_back(Fragment(2, 2, GREEN));
            e_rot.height = 3;
            e_rot.width = 3;
            ...
            s_rot.fragments.push_back(Fragment(2, 1, GREEN));
            s_rot.fragments.push_back(Fragment(0, 2, GREEN));
            s_rot.fragments.push_back(Fragment(1, 2, GREEN));
            s_rot.height = 3;
            s_rot.width = 3;
            
            //Western Rotation
            Rotation w_rot;
            w_rot.fragments.push_back(Fragment(1, 0, GREEN));
            w_rot.fragments.push_back(Fragment(1, 1, GREEN));
            w_rot.fragments.push_back(Fragment(2, 1, GREEN));
            w_rot.fragments.push_back(Fragment(2, 2, GREEN));
            w_rot.height = 3;
            w_rot.width = 3;
        ...
        case Z_PIECE:{
            ...
            //Northern(standard) Rotation
            Rotation n_rot;
            n_rot.fragments.push_back(Fragment(0, 1, RED));
            n_rot.fragments.push_back(Fragment(1, 1, RED));
            n_rot.fragments.push_back(Fragment(1, 2, RED));
            n_rot.fragments.push_back(Fragment(2, 2, RED));
            n_rot.height = 3;
            n_rot.width = 3;
            ...
            //Southern Rotation
            Rotation s_rot;
            s_rot.fragments.push_back(Fragment(0, 1, RED));
            s_rot.fragments.push_back(Fragment(1, 1, RED));
            s_rot.fragments.push_back(Fragment(1, 2, RED));
            s_rot.fragments.push_back(Fragment(2, 2, RED));
            s_rot.height = 3;
            s_rot.width = 3;
        ...
        case L_PIECE:{
            ...
            // Northern(standard) Rotation
            Rotation n_rot;
            n_rot.fragments.push_back(Fragment(1, 0, ORANGE));
            n_rot.fragments.push_back(Fragment(1, 1, ORANGE));
            ...
            e_rot.fragments.push_back(Fragment(1, 1, ORANGE));
            e_rot.fragments.push_back(Fragment(2, 1, ORANGE));
            e_rot.fragments.push_back(Fragment(2, 2, ORANGE));
            e_rot.height = 3;
            e_rot.width = 3;
            
            // Southern Rotation
            Rotation s_rot;
            s_rot.fragments.push_back(Fragment(2, 0, ORANGE));
            ...
            // Western Rotation
            Rotation w_rot;
            w_rot.fragments.push_back(Fragment(0, 0, ORANGE));
